...
class MultiBoxLoss(nn.Module):
    ...
    def forward(self, predictions, targets):
        ...
        # print("loc_t_____________", loc_t.shape)
        # print(loc_t)
        ...
        # print("_______loc_t________0000", loc_t.shape)
        # print(loc_t)
        # print("pos_idx", pos_idx.shape)
        # print(pos_idx)
        ...
        # print(loc_p, '\n', loc_t)
        # print("_______loc_p________", loc_p.shape)
        # print(loc_p)
        # print("_______loc_t________1111", loc_t.shape)
        # print(loc_t)
