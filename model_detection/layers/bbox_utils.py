...
def match_ssd(threshold, truths, priors, variances, labels, loc_t, conf_t, idx):
    ...
    loc_t[idx] = loc  # [num_priors,4] encoded offsets to learn
    conf_t[idx] = conf  # [num_priors] top class label for each prior
    # print("loc____________________________________", loc.shape)
    # print(loc)
...
def encode(matched, priors, variances):
    ...
    # print("g_cxcy_________000", g_cxcy.shape)
    # print(g_cxcy)

    # print("priors[:, :2]__________", priors[:, :2].shape)
    # print(priors[:, :2])
    # encode variance
    g_cxcy /= (variances[0] * priors[:, 2:])

    # print("g_cxcy_________111", g_cxcy.shape)
    # print(g_cxcy)
    ...
    a = torch.cat([g_cxcy, g_wh], 1)

    # print("torch.cat([g_cxcy, g_wh], 1)________", a.shape)
    # print(a)
