...
OPS = {
    ...
    'reluconv_3x3': lambda C_in, C_out: ReLUConv(C_in, C_out, 3),
...
OPS2 = {
    ...
    'max_pool_3x3': lambda C_in, C_out: nn.MaxPool2d(3, stride=1, padding=1),
    'skip_connect': lambda C_in, C_out: Identity(),
    'conv_1x1': lambda C_in, C_out: ConvBlock2(C_in, C_out, 1),
    'conv_3x3': lambda C_in, C_out: ConvBlock2(C_in, C_out, 3),
    'conv_5x5': lambda C_in, C_out: ConvBlock2(C_in, C_out, 5),
    'conv_7x7': lambda C_in, C_out: ConvBlock2(C_in, C_out, 7),
    'reluconv_3x3': lambda C_in, C_out: ReLUConv2(C_in, C_out, 3),
    'dilconv_3x3': lambda C_in, C_out: ConvBlock2(C_in, C_out, 3, dilation=2),
    'dilconv_5x5': lambda C_in, C_out: ConvBlock2(C_in, C_out, 5, dilation=2),
    'dilconv_7x7': lambda C_in, C_out: ConvBlock2(C_in, C_out, 7, dilation=2),
    'resconv_1x1': lambda C_in, C_out: ResBlock2(C_in, C_out, 1),
    'resconv_3x3': lambda C_in, C_out: ResBlock2(C_in, C_out, 3),
    'resconv_5x5': lambda C_in, C_out: ResBlock2(C_in, C_out, 5),
    'resconv_7x7': lambda C_in, C_out: ResBlock2(C_in, C_out, 7),
    'resdilconv_3x3': lambda C_in, C_out: ResBlock2(C_in, C_out, 3, dilation=2),
    'resdilconv_5x5': lambda C_in, C_out: ResBlock2(C_in, C_out, 5, dilation=2),
    'resdilconv_7x7': lambda C_in, C_out: ResBlock2(C_in, C_out, 7, dilation=2),
}
...
class ConvBlock2(nn.Module):
    ...
    def __init__(self, C_in, C_out, kernel_size, stride=2, dilation=1, groups=1):
...
class ReLUConv2(nn.Module):
    def __init__(self, C_in, C_out, kernel_size=3, stride=2):
        super(ReLUConv2, self).__init__()
        self.out_channels = C_out
        self.conv = nn.Sequential(
            nn.Conv2d(C_in, C_out, kernel_size, stride, padding=1),
            nn.ReLU(inplace=True)
